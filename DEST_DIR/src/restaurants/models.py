...
class RestaurantLocation(models.Model):
	owner  		=models.ForeignKey(User) #class_instance.model_set.all() # For 'Django Models Unleashed' check out joincfe.com 
...
def rl_pre_save_receiver(sender,instance, *args, **kwargs):
	...
	if not instance.slug: 
		...
		# here there is no need to save any cause it automatically saves and we dont have to write instance.save()

#def rl_post_save_receiver(sender,instance,creator,*args,**kwargs):
#	print("saved")
